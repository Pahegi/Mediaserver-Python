...
def test_resolve_path_valid(tmp_path):
    ...
    server.player.shutdown()


def test_resolve_path_out_of_range(tmp_path):
...
def test_resolve_path_missing_mediadir(tmp_path):
...
def test_resolve_media_url_from_txt(tmp_path):
...
def test_resolve_media_regular_file(tmp_path):
...
def test_resolve_media_empty_txt(tmp_path):
